...
from APIs.extra_and_virtual_data.models.extra_data import (ExtraDataInfoKeys, ExtraData,
                                                           ExtraDataList, ExtraDataKeys,
                                                           ExtraDataMetaDataInfoKeys, ExtraDataMetaData,
                                                           ExtraDataMetaDataList, ExtraDataMetadataKeys)
...
def build_extra_data_model_entry_data():
    return {
        ExtraDataInfoKeys.DATA_NAME: choice(extra_data_model_data_names),
        ExtraDataInfoKeys.DATA_VALUE: choice(extra_data_model_data_values),
        ExtraDataInfoKeys.DATA_NUMERIC_VALUE: randrange(10),
        ExtraDataInfoKeys.ROW_NUMBER_ID: randrange(1000),
    }
...
def build_extra_data_model_metadata_entry_data():
    return {
        ExtraDataMetaDataInfoKeys.DATA_NAME: choice(extra_data_model_data_names),
        ExtraDataMetaDataInfoKeys.DISPLAY_NAME: choice(extra_data_model_data_values),
        ExtraDataMetaDataInfoKeys.EXTRA_DATA_TYPE: choice(metadata_data_types),
    }
...
class TestExtraData(unittest.TestCase, CommonResponseValidations):
    def test_extra_data_entry_model(self):
        ...
        extra_data_entry_model = ExtraData(**extra_data_entry_args)
        self._validate_response(model=extra_data_entry_model, model_data=extra_data_entry_args)

    def test_extra_data_entry_list(self):
        extra_data_entry_list_model = ExtraDataList(*extra_data_model_entries)
    ...
    def test_extra_data_only_response(self):
        ...
        extra_data_response = GetExtraDataResponse(**extra_data_args)
...
class TestExtraMetadataData(unittest.TestCase, CommonResponseValidations):
    def test_extra_data_metadata_entry_model(self):
        ...
        extra_data_entry_model = ExtraDataMetaData(**extra_data_metadata_entry_args)
        self._validate_response(model=extra_data_entry_model, model_data=extra_data_metadata_entry_args)

    def test_extra_data_entry_list(self):
        extra_data_md_entry_list_model = ExtraDataMetaDataList(*extra_data_model_md_entries)
    ...
    def test_extra_data_metadata_only_response(self):
        ...
        extra_data_md_response = GetExtraDataResponse(**extra_data_md_args)
